				...
				<div class="admin_event_insert_cont">
					<form method="post" action="admin_event_insert_ok" enctype="multipart/form-data">
						...
						<div class="admin_content_btn_box">
							<input type="button" class="cancle_btn" value="취소" onclick="location.href='admin_event_list'">&nbsp;&nbsp;&nbsp;
							<input type="submit" class="insert_btn" value="등록" onclick="location.href='admin_event_insert_ok'">
						</div>
					</form>
				</div>
			</div>
