...
public class MypageQnaSearchAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		cnt = dao.countQnaBoardSearchList(field, keyword);
		...
		List<QnaBoardDTO> list = dao.searchQnaBoard(field, keyword, dto.getUser_id(),page, rowsize);
		...
		forward.setPath("/WEB-INF/views/public/mypage/mypage_qna_board.jsp");
