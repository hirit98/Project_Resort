...
public class AdminReservationInsertOkAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		String start = request.getParameter("checkIn").trim();
		String end = request.getParameter("checkOut").trim();
