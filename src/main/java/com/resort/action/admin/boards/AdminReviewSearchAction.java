...
public class AdminReviewSearchAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		cnt = dao.countReviewSearchList(field, keyword);
		...
		List<ReviewBoardDTO> list = dao.searchReviewList(field, keyword, page, rowsize);
		...
		forward.setPath("/WEB-INF/views/admin/boards/admin_review_list.jsp");
