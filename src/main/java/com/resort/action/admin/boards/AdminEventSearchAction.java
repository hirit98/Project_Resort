...
public class AdminEventSearchAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		cnt = dao.countEventSearchList(field, keyword);
		...
		List<EventBoardDTO> list = dao.searchEventList(field, keyword, page, rowsize);
		...
		forward.setPath("/WEB-INF/views/admin/boards/admin_event_list.jsp");
