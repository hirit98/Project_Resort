...
public class AdminAccountSearchAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		cnt = dao.countAdminSearchList(field, keyword);
		...
		List<AdminDTO> list = dao.searchAdminList(field, keyword, page, rowsize);
		...
		forward.setPath("/WEB-INF/views/admin/account/admin_account_list.jsp");
