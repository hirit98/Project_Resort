...
public class AdminQnaSearchAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		cnt = dao.countQnaSearchList(field, keyword);
		...
		List<QnaBoardDTO> list = dao.searchQnaList(field, keyword, page, rowsize);
		...
		forward.setPath("/WEB-INF/views/admin/management/admin_qna_list.jsp");
