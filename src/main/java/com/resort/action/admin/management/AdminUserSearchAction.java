...
public class AdminUserSearchAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		cnt = dao.countUserSearchList(field, keyword);
		...
		List<UserDTO> list = dao.searchUserList(field, keyword, page, rowsize);
		...
		forward.setPath("/WEB-INF/views/admin/management/admin_user_list.jsp");
