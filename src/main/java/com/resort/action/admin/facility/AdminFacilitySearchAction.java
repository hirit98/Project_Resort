...
public class AdminFacilitySearchAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		cnt = dao.countFacilitySearchList(type);
		...
		List<FacilityinfoDTO> list = dao.searchFacilityList(type, page, rowsize);
		...
		forward.setPath("/WEB-INF/views/admin/facility/admin_facility_list.jsp");
