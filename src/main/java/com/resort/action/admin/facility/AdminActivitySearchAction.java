...
public class AdminActivitySearchAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		cnt = dao.countActivitySearchList(type);
		...
		List<ActivityInfoDTO> list = dao.searchActivityList(type, page, rowsize);
